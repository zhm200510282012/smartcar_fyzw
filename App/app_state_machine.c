...
void app_state_machine_init(app_context_t *ctx)
{
    ...
    ctx->attitude.spi_ok = APP_FALSE;
    ctx->attitude.who_am_i = 0u;
    ctx->attitude.accel_raw[0] = 0;
    ctx->attitude.accel_raw[1] = 0;
    ctx->attitude.accel_raw[2] = 0;
    ctx->attitude.gyro_raw[0] = 0;
    ctx->attitude.gyro_raw[1] = 0;
    ctx->attitude.gyro_raw[2] = 0;
    ctx->attitude.pitch_rate_cdeg_s = 0;
    ctx->attitude.timestamp_ms = 0ul;
    ctx->encoder.left_count = 0l;
    ctx->encoder.right_count = 0l;
    ctx->encoder.left_delta_counts = 0;
    ctx->encoder.right_delta_counts = 0;
    ctx->encoder.left_speed_counts_per_s = 0;
    ctx->encoder.right_speed_counts_per_s = 0;
    ctx->encoder.left_speed_mm_s = 0;
    ctx->encoder.right_speed_mm_s = 0;
    ctx->encoder.left_distance_mm = 0l;
    ctx->encoder.right_distance_mm = 0l;
    ctx->encoder.speed_mm_s_valid = APP_FALSE;
    ctx->encoder.progress_mm_valid = APP_FALSE;
