...
| S05_wall_to_ground_transition | logical_wall | candidate event, wall hold, transition-down pitch ramp | finished | state sequence, profile gates, precharge ordering, command ranges, suction output lock |
